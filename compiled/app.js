...
var _user$project$Helper$addCmd = F2(
	function (cmd_, _p0) {
		var _p1 = _p0;
		return {
			ctor: '_Tuple2',
...
var _user$project$Helper$replace = F3(
...
var _user$project$Ports$saveToLocalStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'saveToLocalStorage',
	function (v) {
		return v;
	});
var _user$project$Ports$processLocalStorage = _elm_lang$core$Native_Platform.incomingPort('processLocalStorage', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$handleLocalStorageLoad = _elm_lang$core$Native_Platform.outgoingPort(
	'handleLocalStorageLoad',
	function (v) {
		return null;
	});

var _user$project$Model$modelAsJson = F2(
		...
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'gifUrl',
						_1: _elm_lang$core$Json_Encode$string(model.gifUrl)
					},
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Model$modelAsJsonEasy = function (model) {
	return A2(_user$project$Model$modelAsJson, model, model.topic);
};
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {topic: a, gifUrl: b, giphyUrl: c, gifHistory: d, loadingDisplay: e, showLoadError: f};
	});
var _user$project$Model$GifHistoryModel = F2(
	function (a, b) {
		return {imageUrl: a, giphyUrl: b};
	});
var _user$project$Model$LocalStorageModel = F2(
	function (a, b) {
		return {topic: a, gifUrl: b};
	});
var _user$project$Model$modelDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Model$LocalStorageModel,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$Model$decodeModelFromLocalStorage = F2(
	function (model, fromStorage) {
		var _p0 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Model$modelDecoder, fromStorage);
		if (_p0.ctor === 'Ok') {
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.update(
				model,
				{topic: _p1.topic, gifUrl: _p1.gifUrl});
		} else {
			return model;
		}
	});
var _user$project$Model$GiphyJsonDecodeModel = F3(
	function (a, b, c) {
		return {gifUrl: a, lowResImageUrl: b, giphyUrl: c};
	});
var _user$project$Model$giphyJsonDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Model$GiphyJsonDecodeModel,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
...
var _user$project$Update$loadFromLocalStorage = _user$project$Ports$handleLocalStorageLoad(
	{ctor: '_Tuple0'});
var _user$project$Update$LoadLocalStorage = function (a) {
	return {ctor: 'LoadLocalStorage', _0: a};
};
var _user$project$Update$FinishedLoading = {ctor: 'FinishedLoading'};
var _user$project$Update$TopicChange = function (a) {
	return {ctor: 'TopicChange', _0: a};
};
var _user$project$Update$NewGif = function (a) {
	return {ctor: 'NewGif', _0: a};
};
var _user$project$Update$getRandomGif = function (topic) {
	var giphyTopic = A3(_user$project$Helper$replace, ' ', '+', topic);
	var url = A2(_elm_lang$core$Basics_ops['++'], 'https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=', giphyTopic);
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Model$giphyJsonDecoder);
	return A2(_elm_lang$http$Http$send, _user$project$Update$NewGif, request);
};
var _user$project$Update$InitialLoad = function (a) {
	return {ctor: 'InitialLoad', _0: a};
};
var _user$project$Update$init = {
	...
	_0: A6(
		...
		true,
		false),
	_1: A2(_elm_lang$core$Task$perform, _user$project$Update$InitialLoad, _elm_lang$core$Time$now)
};
var _user$project$Update$MorePleaseOnTimer = function (a) {
	return {ctor: 'MorePleaseOnTimer', _0: a};
};
var _user$project$Update$fireMorePleaseIfLocalStorageEmpty = function (fromStorage) {
	return _elm_lang$core$Native_Utils.eq(fromStorage, '') ? A2(_elm_lang$core$Task$perform, _user$project$Update$MorePleaseOnTimer, _elm_lang$core$Time$now) : _elm_lang$core$Platform_Cmd$none;
};
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'InitialLoad':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Update$loadFromLocalStorage};
			case 'FinishedLoading':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loadingDisplay: false, showLoadError: false}),
					_1: _user$project$Ports$saveToLocalStorage(
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_user$project$Model$modelAsJsonEasy(model)))
				};
			case 'MorePlease':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$getRandomGif(model.topic)
				};
			case 'MorePleaseOnTimer':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Update$getRandomGif(model.topic)
				...
				return {
					...
					_1: _user$project$Ports$saveToLocalStorage(
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							A2(_user$project$Model$modelAsJson, model, _p1)))
				};
			case 'NewGif':
				if (_p0._0.ctor === 'Ok') {
					var _p2 = _p0._0._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								gifUrl: _p2.gifUrl,
								giphyUrl: _p2.giphyUrl,
								loadingDisplay: true,
								showLoadError: false,
								gifHistory: {
									ctor: '::',
									_0: A2(_user$project$Model$GifHistoryModel, _p2.lowResImageUrl, _p2.giphyUrl),
									_1: model.gifHistory
								}
							}),
			...
			default:
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$decodeModelFromLocalStorage, model, _p3),
					_1: _user$project$Update$fireMorePleaseIfLocalStorageEmpty(_p3)
				};
		}
	});
var _user$project$Update$MorePlease = {ctor: 'MorePlease'};

var _user$project$View$historyListStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$marginTop('7rem'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$marginBottom('3rem'),
		_1: {
			ctor: '::',
...
var _user$project$View$historyLinkUlStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$marginTop('10rem'),
	_1: {ctor: '[]'}
};
var _user$project$View$gifHistoryItemImage = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$width('100px'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$height('100px'),
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$padding('3px'),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$View$gifHistoryItem = function (item) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(item.giphyUrl),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_user$project$View$gifHistoryItemImage),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$View$renderHistoryList = function (gifHistory) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_user$project$View$historyListStyle),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$View$gifHistoryItem, gifHistory));
};
var _user$project$View$showStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'visibility', _1: 'visible'},
		_1: {ctor: '[]'}
	});
var _user$project$View$hideStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'visibility', _1: 'hidden'},
		_1: {ctor: '[]'}
	});
var _user$project$View$hideLayoutStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'none'},
		_1: {ctor: '[]'}
	});
var _user$project$View$showLayoutStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'initial'},
		_1: {ctor: '[]'}
	});
var _user$project$View$loadingStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$color('#eee'),
	_1: {ctor: '[]'}
};
var _user$project$View$inputStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$width('30%'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$padding('6px 6px'),
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$color('#111'),
			_1: {
				ctor: '::',
				_0: _seanhess$elm_style$Style$margin('0 auto'),
				_1: {
					ctor: '::',
					_0: _seanhess$elm_style$Style$marginTop('2rem'),
					_1: {
						ctor: '::',
						_0: _seanhess$elm_style$Style$marginBottom('2rem'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View$fontStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$fontFamily(
		A2(_elm_lang$core$Basics_ops['++'], '-apple-system, \'.SFNSText-Regular\', San Francisco, Roboto, Segoe UI, ', 'Open Sans, sans-serif')),
	_1: {ctor: '[]'}
};
var _user$project$View$basicStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$marginTop('3rem'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$width('800px'),
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$margin('0 auto'),
			_1: {
...
var _user$project$View$imageHeight = '550px';
var _user$project$View$imageContainer = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$margin('0 auto'),
	_1: {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$height(_user$project$View$imageHeight),
			_1: {
				ctor: '::',
				_0: _seanhess$elm_style$Style$display('flex'),
				_1: {
...
var _user$project$View$imageStyle = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$display(_seanhess$elm_style$Style$block),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$height(_user$project$View$imageHeight),
		_1: {ctor: '[]'}
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_user$project$View$fontStyle),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$View$basicStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Update$MorePlease),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_0: _elm_lang$html$Html_Attributes$style(
										A2(_elm_lang$core$Basics_ops['++'], _user$project$View$inputStyle, _user$project$View$fontStyle)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('text'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Update$TopicChange),
											_1: {
												ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(_user$project$View$imageContainer),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(_user$project$View$imageStyle),
										_1: {
											ctor: '::',
											_0: model.showLoadError ? _user$project$View$hideLayoutStyle : _user$project$View$showLayoutStyle,
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html_Events$on,
														'load',
														_elm_lang$core$Json_Decode$succeed(_user$project$Update$FinishedLoading)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(_user$project$Update$MorePlease),
														_1: {ctor: '[]'}
													}
												}
											}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: model.showLoadError ? _user$project$View$showLayoutStyle : _user$project$View$hideLayoutStyle,
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Can\'t find any image for that topic!'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$style(_user$project$View$loadingStyle),
									_1: {
										ctor: '::',
										_0: model.loadingDisplay ? _user$project$View$showStyle : _user$project$View$hideStyle,
										_1: {ctor: '[]'}
									}
								},
								{
							...
							_1: {
								ctor: '::',
								_0: _user$project$View$renderHistoryList(model.gifHistory),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$processLocalStorage(_user$project$Update$LoadLocalStorage),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 6, _user$project$Update$MorePleaseOnTimer),
				_1: {ctor: '[]'}
			}
		});
};
